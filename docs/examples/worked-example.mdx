...
<Steps>
  ...
  <Step title="Capability binding">
    The Agent Runtime validates the declared capability IDs. Runtime configuration and the Action Plane bind those requirements to concrete MCP clients and servers according to local configuration and policy.
  </Step>
