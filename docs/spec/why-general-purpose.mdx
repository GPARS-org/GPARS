...
<CardGroup cols={1}>
  ...
  <Card title="Externalized tools via MCP make the capability surface composable" icon="puzzle-piece">
    The agent can operate across environments where the Action Plane can satisfy its declared capability requirements. Adding capabilities means adding or binding MCP servers — the agent doesn't change.
  </Card>
