...
<AccordionGroup>
  ...
  <Accordion title="Declarative Environment Requirements">
    Ensures deterministic agent behavior and runtime portability without binding the agent to specific MCP server implementations. An agent's manifest describes what it needs to function using manifest-local capability references and human-readable descriptions.
  </Accordion>
